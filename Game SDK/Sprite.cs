...
namespace fesbGameSDK
{
    ...
    public abstract class Sprite
    {
        ...
        protected int x, y; //protected jer ćemo ga override
        ...
        public virtual int X //virtual jer ćemo ga override
        {
            get { return x; }
            set
            {
        ...
        /// </summary>
        /// <remarks><c>set</c> osigurava da lik ne izlazi van ruba <see cref="GameOptions"/></remarks>
        public virtual int Y  //virtual jer ćemo ga override
        {
            get { return y; }
            set { y = value; }
        }
        ...
        //promijenjeno radi vitamina i damage koji nemaju set
        protected int costumeIndex;
        public virtual int CostumeIndex
        {
            get { return costumeIndex; }
            set { costumeIndex = value; }
        }
